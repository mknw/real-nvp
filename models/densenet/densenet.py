"""
This code was originally adopted from: [1] https://github.com/jornpeters/integer_discrete_flows
...
class DenseBlock(nn.Module):
    def __init__(
        ...
        layers = []
        report = {'layer_'+str(i+1): {'I': 0, 'O': 0}  for i in range(depth)}
        ...
        for d in range(depth):
            ...
            report['layer_'+str(d+1)]['I'] = in_c
            report['layer_'+str(d+1)]['O'] = growth
